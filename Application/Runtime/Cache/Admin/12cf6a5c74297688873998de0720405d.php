...
<div class="form-div">
    <form action="/index.php/Admin/Goods/lst" method="GET" name="searchForm">  
        ...
        <p>
            添加时间:
            从<input value="<?php echo I('get.fa'); ?>" type="text" id="fa" name="fa" size="20" />
            到<input value="<?php echo I('get.ta'); ?>" type="text" id="ta" name="ta" size="20" />
        </p>
        <p>
            排序方式:
            <?php $odby=I('get.odby', 'id_desc'); ?><!-- 如果odby为空,那么默认是id_desc -->
